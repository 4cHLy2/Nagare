...
export default function JsonEditor() {
  ...
  // pull in outside changes, but NOT while the cursor is in here or it
  // reformats mid-keystroke and the cursor jumps to the end
  useEffect(() => {
    if (!focused.current) {
  ...
  // live on every keystroke. invalid = keep the text, show the error, dont commit
