...
export default function BudgetEditor() {
  ...
  // resolve through the same map the canvas uses or the swatches lie
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.4rem' }}>
      ...
      <section>
        ...
        {/* net row. not a real budget row but has to look like one */}
      ...
      <section>
        ...
        {/* leftover / overspent / exact. three states */}
...
// yank the symbol out of a formatted 0 by deleting digits/separators. gross but
// there is no Intl api for "just give me the symbol"
