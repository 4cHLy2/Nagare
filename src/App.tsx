...
export default function App() {
  ...
  // panel state is not persisted. TODO? nobody asked
  ...
  // ctrl+z / ctrl+shift+z / ctrl+y. bail if theyre typing somewhere
  useEffect(() => {
...
const shell: React.CSSProperties = {
  ...
  gridTemplateColumns: 'minmax(0, 1fr)', // minmax or a long label blows out the viewport
  height: '100%',
  width: '100%',
  overflow: 'hidden',
};
